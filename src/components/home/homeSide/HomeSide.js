...
function User({data}) {
    ...
    return <div className="profile" >
        <div className="image small"><img src={data.image ? data.image : testImg} alt="icon" /></div>
        <div className='info'>
            <h3>{data.username}</h3>
            <p>{data.name}</p>
        </div>
...
export default function HomeSide() {
    ...
    return <div className="homeSide">
        <div className="profile">
            <div className="image"><img src={auth.user.image ? api.url + auth.user.image : testImg} alt="icon" /></div>
            <div className='info'>
